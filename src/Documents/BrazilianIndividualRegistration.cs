...
public static class BrazilianIndividualRegistration
{
    ...
    /// </summary>
    /// <param name="region">
    /// CPF region code (one digits) Ex: 4.
    /// </param>
    /// <param name="formatted">
    /// Format the individual registration (CPF) Ex: 000.000.000-00.
    /// </param>
    /// <returns>
    /// A random individual registration (CPF).
    /// </returns>
    ...
    /// Format the individual registration (CPF) Ex: 000.000.000-00.
    /// </summary>
    /// <param name="individualRegistration">
    /// Individual registration (CPF) Ex: 00000000000.
    /// </param>
    /// <returns>
    /// Formatted individual registration (CPF) Ex: 000.000.000-00.
    /// </returns>
    ...
    /// </summary>
    /// <param name="individualRegistration">
    /// Individual registration (CPF) Ex: 00000000000 or 000.000.000-00.
    /// </param>
    /// <returns>
    /// Information about the individual registration (CPF).
    /// </returns>
    public static IndividualRegistrationInfo GetInfo(string individualRegistration)
    {
        ...
        return new IndividualRegistrationInfo(
            ...
            ParseDigit(individualRegistration[8]));
    }
